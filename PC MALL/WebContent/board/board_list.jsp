...
<%
 ...
 %>
		<tr height=22 bgcolor=ffffff onMouseOver=this.style.backgroundColor='#FFF8DE'  onMouseOut=this.style.backgroundColor='#FFFFFF'>
			...
			<td width=230 align="left"><a href='BoardCheckPass.jsp?b_id=<%= b_id %>'>
<%			
				if(level>0) { 
...
%>
			...
			<td width=180 height=30 valign=middle align=right>
		       <c:if test="${sessionScope.sessionID!=null}">
			     <a href="write_form.jsp"><img src="/board/img/m_bt10.gif" border=0 align=absmiddle></a>
			   </c:if>
			<a href="board_list.jsp"><img src="/board/img/m_bt06.gif" border=0 align=absmiddle></a>
			</td>
			<td width=10>&nbsp;</td>
		</tr>
	</table>
